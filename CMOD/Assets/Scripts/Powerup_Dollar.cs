...
public class Powerup_Dollar : MonoBehaviour
{
    ...
    {
        //Is colliding object a plater? cannot collide with enemies
        ...
        //Get Plater Controller onject and update cash
        //PlayerController PC = Other.gameObject.GetComponent<PlayerController>();

        //If there is a PC attached to colliding object, then update cash
        //if (PC) PC.Cash += CashAmount;

        //Post power up collected notificaton, so other onjects can handle this event if required
